...
// Clean camera positioning - straight view, no tilt
camera.position.x = 0;
camera.position.y = 2.0;
camera.position.z = 2;
camera.rotation.x = -Math.PI * 0.3;  // Slight downward angle to see controller
camera.rotation.y = 0;               // No horizontal rotation
camera.rotation.z = 0;               // No tilt

// Apply URL parameter offsets
